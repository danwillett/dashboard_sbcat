...
export default function SafetyFilterPanel(props: any) {
  ...
  const [incidentLayerView, setIncidentLayerView] =
    useState<null | FeatureLayerView>(null);
    ...
    if (
      ...
      reactiveUtils.watch(
        ...
        async () => {
          ...
          heatmapLayer.definitionExpression =
    ...
    >
      <Box sx={{ width: 300 }}>
        ...
        <FormControl fullWidth sx={{ mb: 3 }}>
          <FormLabel
            sx={{ fontSize: "14px", fontFamily: fonts }}
            id="select-road-user-label"
          >
            Select a road user
          </FormLabel>
          <RadioGroup
